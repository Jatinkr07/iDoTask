  ...
  return (
    <>
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-slate-300 min-h-[80vh] md:w-[35%]">
        <h1 className="font-bold text-center text-3xl text">
          iDoTask - Manage Your Daily Task
        </h1>
                ...
                <div key={item.id} className={"todo flex my-3 justify-between"}>
                  ...
                  <div className="buttons flex h-full">
                    <button
                      ...
                      className="bg-green-700 hover:bg-green-800 p-2 py-1 text-sm font-bold text-white rounded-md mx-1"
                    >
                      <FaEdit />
                    </button>
                    <button
